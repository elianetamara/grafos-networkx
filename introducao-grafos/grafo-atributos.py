...
print(nx.get_node_attributes(grafo,'label'))

draw_graph(grafo, node_labels=nx.get_node_attributes(grafo,'label'), edge_labels=nx.get_edge_attributes(grafo,'label'))